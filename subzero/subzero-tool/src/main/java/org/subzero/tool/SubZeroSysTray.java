...
public class SubZeroSysTray {
    ...
    private static void switchPauseMode(boolean pauseMode) {
    	...
    	String message = "";
		try {
			message = String.format(SUBZERO_POPUP_DESCRIPTION, PropertiesHelper.getVersion());
		} catch (Exception e) {
			e.printStackTrace();
		}
        if (pauseMode) {
    ...
    private static void createAndShowGUI() {
        ...
        // Set tool tip message
        try {
			trayIcon.setToolTip(String.format(SUBZERO_POPUP_DESCRIPTION, PropertiesHelper.getVersion()));
		} catch (Exception e) {
			e.printStackTrace();
		}
        ...
        aboutMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	try {
					JOptionPane.showMessageDialog(null, String.format(SUBZERO_POPUP_ABOUT, PropertiesHelper.getVersion(), PropertiesHelper.getReleaseDate()));
